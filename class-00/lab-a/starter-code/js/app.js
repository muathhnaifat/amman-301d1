...
function displayPics(){
  ...
  // console.log(rando);
  // the reason for the erorr because the varible rando is a local varible and only work inside scope of the displayPics function .
  //  and the soultion for that by difind the rando varible outside the displayPics function scope as a global varible .
